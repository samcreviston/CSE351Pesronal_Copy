...
def main():
    ...
    # Retrieve people
    kind_of_threads['characters'] = get_urls(film6, 'characters')
    kind_of_threads['planets'] = get_urls(film6, 'planets')
    kind_of_threads['starships'] = get_urls(film6, 'starships')
    kind_of_threads['vehicles'] = get_urls(film6, 'vehicles')
    kind_of_threads['species'] = get_urls(film6, 'species')
